...
for i in range(12):
    ...
    final_count = (total_time, sticks_made)
    g = []
    g = final_count
    running_total.append(g)
    total = pd.DataFrame(running_total)
...
# total.insert(2, "Total", [291, 272, 312, 287, 289, 292, 289, 290, 288, 289, 288, 288], True)
# total.drop(total.columns[[0]], axis=1, inplace=True)
# print(total)

# Graph
#  ax = total.plot.bar(y='Total', title='Total by Month', rot=0)
# for p in ax.patches:
